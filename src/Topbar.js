...
const Topbar = () => (
  <div className="bg-indigo-dark flex items-center h-10 px-2 select-none">
    <a href="/" className="no-underline text-white p-2">
      <h1 className="text-xl font-normal tracking-normal">React.parts</h1>
    </a>

    <div className="flex-1" />

    <a href="https://js.coach" className="no-underline text-grey-light p-2">
      JS.coach
    </a>
    <a
    ...
    <a href="http://blog.js.coach/" className="no-underline text-white py-2 px-3">
      Blog
    </a>
    <a href="mailto:hello@js.coach" className="no-underline text-white p-2 leading-none">
    ...
    <a href="https://twitter.com/_jscoach" className="no-underline text-white p-2 leading-none">
      <svg viewBox="0 0 16 16" width="16" height="16" xmlns="http://www.w3.org/2000/svg">
    ...
    <a
      href="https://github.com/dmfrancisco/reactparts-client"
      className="no-underline text-white p-2 leading-none">
      <svg viewBox="0 0 16 16" width="16" height="16" xmlns="http://www.w3.org/2000/svg">
